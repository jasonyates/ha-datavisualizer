 ...
 */
const R = globalThis, W = R.ShadowRoot && (R.ShadyCSS === void 0 || R.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, Z = Symbol(), F = /* @__PURE__ */ new WeakMap();
let ht = class {
  constructor(t, e, s) {
...
const pt = (r) => new ht(typeof r == "string" ? r : r + "", void 0, Z), ut = (r, ...t) => {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: _t, defineProperty: ft, getOwnPropertyDescriptor: yt, getOwnPropertyNames: mt, getOwnPropertySymbols: gt, getPrototypeOf: At } = Object, f = globalThis, Q = f.trustedTypes, vt = Q ? Q.emptyScript : "", L = f.reactiveElementPolyfillSupport, C = (r, t) => r, k = { toAttribute(r, t) {
  switch (t) {
    case Boolean:
      r = r ? vt : null;
      break;
  ...
  return e;
} }, J = (r, t) => !_t(r, t), X = { attribute: !0, type: String, converter: k, reflect: !1, useDefault: !1, hasChanged: J };
...
let b = class extends HTMLElement {
  ...
  _$AK(t, e) {
    ...
    if (i !== void 0 && this._$Em !== i) {
      const a = s.getPropertyOptions(i), h = typeof a.converter == "function" ? { fromAttribute: a.converter } : ((o = a.converter) == null ? void 0 : o.fromAttribute) !== void 0 ? a.converter : k;
      this._$Em = i;
  ...
  requestUpdate(t, e, s, i = !1, o) {
    ...
    if (t !== void 0) {
      ...
      if (i === !1 && (o = this[t]), s ?? (s = a.getPropertyOptions(t)), !((s.hasChanged ?? J)(o, e) || s.useDefault && s.reflect && o === ((n = this._$Ej) == null ? void 0 : n.get(t)) && !this.hasAttribute(a._$Eu(t, s)))) return;
      this.C(t, e, s);
    }
...
b.elementStyles = [], b.shadowRootOptions = { mode: "open" }, b[C("elementProperties")] = /* @__PURE__ */ new Map(), b[C("finalized")] = /* @__PURE__ */ new Map(), L == null || L({ ReactiveElement: b }), (f.reactiveElementVersions ?? (f.reactiveElementVersions = [])).push("2.1.2");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const x = globalThis, Y = (r) => r, D = x.trustedTypes, tt = D ? D.createPolicy("lit-html", { createHTML: (r) => r }) : void 0, at = "$lit$", _ = `lit$${Math.random().toFixed(9).slice(2)}$`, lt = "?" + _, bt = `<${lt}>`, A = document, O = () => A.createComment(""), U = (r) => r === null || typeof r != "object" && typeof r != "function", K = Array.isArray, Et = (r) => K(r) || typeof (r == null ? void 0 : r[Symbol.iterator]) == "function", B = `[ 	
\f\r]`, S = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, et = /-->/g, st = />/g, y = RegExp(`>|${B}(?:([^\\s"'>=/]+)(${B}*=${B}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), it = /'/g, rt = /"/g, ct = /^(?:script|style|textarea|title)$/i, wt = (r) => (t, ...e) => ({ _$litType$: r, strings: t, values: e }), I = wt(1), E = Symbol.for("lit-noChange"), d = Symbol.for("lit-nothing"), nt = /* @__PURE__ */ new WeakMap(), m = A.createTreeWalker(A, 129);
function dt(r, t) {
...
const St = (r, t) => {
  ...
  for (let a = 0; a < e; a++) {
    const h = r[a];
    let c, p, l = -1, u = 0;
    for (; u < h.length && (n.lastIndex = u, p = n.exec(h), p !== null); ) u = n.lastIndex, n === S ? p[1] === "!--" ? n = et : p[1] !== void 0 ? n = st : p[2] !== void 0 ? (ct.test(p[2]) && (i = RegExp("</" + p[2], "g")), n = y) : p[3] !== void 0 && (n = y) : n === y ? p[0] === ">" ? (n = i ?? S, l = -1) : p[1] === void 0 ? l = -2 : (l = n.lastIndex - p[2].length, c = p[1], n = p[3] === void 0 ? y : p[3] === '"' ? rt : it) : n === rt || n === it ? n = y : n === et || n === st ? n = S : (n = y, i = void 0);
    const $ = n === y && r[a + 1].startsWith("/>") ? " " : "";
    o += n === S ? h + bt : l >= 0 ? (s.push(c), h.slice(0, l) + at + h.slice(l) + _ + $) : h + _ + (l === -2 ? a : $);
  }
    ...
    for (; (i = m.nextNode()) !== null && h.length < a; ) {
      if (i.nodeType === 1) {
        if (i.hasAttributes()) for (const l of i.getAttributeNames()) if (l.endsWith(at)) {
          ...
          h.push({ type: 1, index: o, name: T[2], strings: $, ctor: T[1] === "." ? xt : T[1] === "?" ? Pt : T[1] === "@" ? Ot : z }), i.removeAttribute(l);
...
class H {
  ...
  _$AI(t, e = this) {
    t = w(this, t, e), U(t) ? t === d || t == null || t === "" ? (this._$AH !== d && this._$AR(), this._$AH = d) : t !== this._$AH && t !== E && this._(t) : t._$litType$ !== void 0 ? this.$(t) : t.nodeType !== void 0 ? this.T(t) : Et(t) ? this.k(t) : this._(t);
  }
  O(t) {
...
class z {
  ...
  _$AI(t, e = this, s, i) {
    ...
    let n = !1;
    if (o === void 0) t = w(this, t, e, 0), n = !U(t) || t !== this._$AH && t !== E, n && (this._$AH = t);
    else {
      const a = t;
      let h, c;
      for (t = o[0], h = 0; h < o.length - 1; h++) c = w(this, a[s + h], e, h), c === E && (c = this._$AH[h]), n || (n = !U(c) || c !== this._$AH[h]), c === d ? t = d : t !== d && (t += (c ?? "") + o[h + 1]), this._$AH[h] = c;
    }
    n && !i && this.j(t);
  }
  j(t) {
...
const V = x.litHtmlPolyfillSupport;
V == null || V(N, H), (x.litHtmlVersions ?? (x.litHtmlVersions = [])).push("3.3.2");
const Nt = (r, t, e) => {
...
const q = g.litElementPolyfillSupport;
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Mt = { attribute: !0, type: String, converter: k, reflect: !1, hasChanged: J }, Tt = (r = Mt, t, e) => {
...
var kt = Object.defineProperty, Dt = Object.getOwnPropertyDescriptor, M = (r, t, e, s) => {
...
let v = class extends P {
  constructor() {
    super(...arguments), this.narrow = !1, this.route = "", this._view = "list";
  }
  render() {
    return I`
      <div class="container">
...
v = M([
  Ht("ha-data-visualizer")
], v);
export {
  v as HaDataVisualizer
};
